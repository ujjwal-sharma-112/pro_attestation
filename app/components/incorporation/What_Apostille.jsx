      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 text-center">
            What is Certificate of Incorporation Apostille and Attestation?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              Apostille verifies your company's registration certificate for Hague Convention countries.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-base text-gray-600">
              Attestation is required for non-Hague nations via embassy processes.
              </p>
            </motion.div>
          </div>
        </motion.div>
