        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Planning international business operations? You’ll need your <b>Certificate of Incorporation Apostille or Company Registration Attestation.</b>
              </p>

              <p className="text-base text-gray-600">
              We provide fast and secure legalization services across India.
              </p>
            </article>
          </motion.div>
