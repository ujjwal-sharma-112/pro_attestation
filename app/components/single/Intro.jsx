        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Planning to marry abroad? You’ll need a Single Status Certificate Apostille or Attestation to prove you are unmarried.
              </p>

              <p className="text-base text-gray-600">
              We offer reliable Single Certificate Apostille services and Embassy Attestation services across India, assisting you from notary to MEA apostille and embassy legalization.
              </p>
            </article>
          </motion.div>
