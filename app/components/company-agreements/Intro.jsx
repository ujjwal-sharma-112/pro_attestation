        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Expanding your business abroad? <b>Company Agreements Apostille or Business Documents Attestation</b> is a must.
              </p>
              <p className="text-lg text-gray-700">
              We assist with the complete legalization of MoUs, Joint Venture Agreements, and Partnership Agreements for international use.              </p>
            </article>
          </motion.div>
