      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 text-center">
            What is Company Agreement Apostille and Attestation?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              Apostille certifies your company agreements for Hague Convention countries.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-base text-gray-600">
              Attestation legalizes them for non-Hague countries via embassy authentication.
            </p>
            </motion.div>
          </div>
        </motion.div>
