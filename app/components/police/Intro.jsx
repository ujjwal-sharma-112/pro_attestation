        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Applying for a visa, job, or PR abroad? A <b>Police Clearance Certificate (PCC)</b> Apostille or Attestation is often mandatory. We provide quick and secure services for PCC Apostille and PCC Embassy Attestation across India
</p>
            </article>
          </motion.div>
