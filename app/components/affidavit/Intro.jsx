        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Need to validate your sworn affidavit for legal, business, or visa purposes abroad? We provide professional <b>Affidavit</b> Apostille and Embassy Attestation services across India.
</p>

              <p className="text-base text-gray-600">
              Whether it's a name change affidavit, address proof affidavit, or general declaration, we handle the complete legalization process efficiently.
              </p>
            </article>
          </motion.div>
