        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Dreaming of studying or working abroad? You need your Degree Certificate Apostille or Degree Attestation legalized.</p>
              <p className="text-lg text-gray-700">
              We offer fast and reliable services for Educational Certificate Apostille and University Degree Attestation for global acceptance.
              </p>
            </article>
          </motion.div>
