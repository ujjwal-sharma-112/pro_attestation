        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Sending authority or rights to someone abroad? You'll need a <b>Power of Attorney Apostille or POA Attestation.</b> We offer complete document legalization for personal and business POA documents.
              </p>
            </article>
          </motion.div>
