        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Traveling for medical treatment or sick leave purposes abroad? You need <b>Medical Certificate</b> Apostille or Attestation.            </p>

              <p className="text-base text-gray-600">
              We provide end-to-end services for <b>Medical Certificate</b> legalization in India.
              </p>
            </article>
          </motion.div>
