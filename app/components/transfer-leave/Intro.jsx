        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Applying for school or college abroad? You may need a <b>Transfer Certificate Apostille or Leaving Certificate Attestation.</b> We help you legalize academic certificates for international educational admissions.
              </p>
            </article>
          </motion.div>
