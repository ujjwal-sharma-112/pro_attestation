        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Doing international trade? Your <b>Import Export Code (IEC) Apostille or Export License Attestation</b> is necessary for foreign business operations.
              </p>

              <p className="text-base text-gray-600">
              We assist companies with fast IEC document legalization across India.
              </p>
            </article>
          </motion.div>
