        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            <article className="space-y-6">
              ...
              Need to claim inheritance, insurance, or settle affairs abroad? You may require Death Certificate Apostille or Attestation.
              </p>

              <p className="text-base text-gray-600">
              We offer expert services for Death Certificate Apostille in India and Embassy Attestation, ensuring smooth documentation for your needs.
              </p>
            </article>
          </motion.div>
